...
One number frames the checker rows. Nib checks **78 of the 106** rules veraPDF evaluates for PDF/UA-1, so
...
- a WCAG check, and the 28 PDF/UA-1 rules Nib does not check;
