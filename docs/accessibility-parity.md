...
| PDF/UA identification in the file | Not described on the cited pages | Never written. A checker covering 19 of the 106 rules cannot support the claim (`/pending 486`) | `TestPassingEveryClauseNibChecksIsNotConformanceAndTheDocsSaySo` | Gap |
