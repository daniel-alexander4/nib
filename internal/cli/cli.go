...
These subcommands run headlessly, without a browser:
  ...
  nib tag commit IN -o OUT --review REVIEW.json   write a reviewed proposal (or -w IN)
  nib tag edit IN -o OUT --edits EDITS.json       correct the existing tree, as one batch (or -w IN)
