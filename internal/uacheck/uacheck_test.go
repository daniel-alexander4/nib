...
func TestEveryRegisteredRuleIsWellFormed(t *testing.T) {
	...
	// /pending 489 to 18, /pending 487 to 19, /pending 548 to 20, P03.S01 to 22, P03.S02 to 39, P03.S03 to 47, P03.S04 to 52 and P03.S05 to 55 — the floor stayed at 15 through four
	...
	if len(clauses) < 55 {
		t.Fatalf("the registry holds %d rule(s); 55 have shipped. A rule dropped from the "+
