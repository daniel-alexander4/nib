...
// measurement overturned it: nib checked 15 of the 106 rules veraPDF evaluates (22 since P03.S01), and a
// Markdown heading that skipped a level passed all of them while failing veraPDF's 7.4.2 t1. That one is checked
// now; the class is not — a paragraph tagged `/Formula` with no alternate text passes all 22 and fails 7.7 t1
